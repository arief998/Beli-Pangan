...
public class ProgressOrderAdapter extends RecyclerView.Adapter<ProgressOrderAdapter.PendingOrder> {
    private LinkedList<Order> list;
    private LayoutInflater iAdapter;

    public ProgressOrderAdapter(Context context, LinkedList<Order> list){
        this.list = list;
    ...
    public PendingOrder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = iAdapter.inflate(R.layout.adapter_progress_order, parent, false);
...
//        ImageView ivProduct;
        ...
        public PendingOrder(@NonNull View itemView, ProgressOrderAdapter adapter) {
            super(itemView);
