...
public class BuyerPendingOrderAdapter extends RecyclerView.Adapter<BuyerPendingOrderAdapter.PendingOrder> {
    private LinkedList<Order> list;
    private LayoutInflater iAdapter;

    public BuyerPendingOrderAdapter(Context context, LinkedList<Order> list){
        this.list = list;
    ...
    public PendingOrder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = iAdapter.inflate(R.layout.adapter_buyer_pending_order, parent, false);
    ...
    public class PendingOrder extends RecyclerView.ViewHolder implements View.OnClickListener {
        BuyerPendingOrderAdapter adapter;
        TextView tvNama, tvHarga, tvStatus;
        CardView cv;
//        ImageView ivProduct;

        public PendingOrder(@NonNull View itemView, BuyerPendingOrderAdapter adapter) {
            super(itemView);
...
//            ivProduct = itemView.findViewById(R.id.ivProductOrder);
        ...
        public void onClick(View view) {
            Intent intent = new Intent(view.getContext(), BuyerPendingDetailActivity.class);
